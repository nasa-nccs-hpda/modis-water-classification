...
def main():
    ...
    days_to_check = ['A{}{:03}'.format(year, day) for day in range(0, 365)]
    print(len(days_to_check))
    nodiff = mod09ga_days & set(days_to_check)
    print(f'Num matching {len(nodiff)}')
    mod09ga_diff = [day for day in days_to_check if day not in nodiff]
